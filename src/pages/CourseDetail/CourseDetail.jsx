      ...
      {course ?
        <Fragment>
                          ...
                          <div className="blog-details blog-sig-details">
                            {course && <Fragment>
                              <div className="details-blog-dt blog-sig-details-dt courses-info mobile-sm-d-n">
                                <span><a href="#"><i className="fa fa-user"></i> <b>Khóa Học:</b> {course.name}</a></span>
                                <span><a href="#"><i className="fa fa-heart"></i> <b>Giá:</b> {course.price}</a></span>
                            ...
                            {subscribers && <Fragment>
                              ...
                              <StarRatings rating={subscribers.point} starRatedColor="#faca51" starDimension="25px" starSpacing="1px" />
                              <p>({subscribers.subscribers_rated.length} đánh giá) ({subscribers.subscribers.length} học viên)</p>
                            </Fragment>}
          ...
          <div className="courses-area">
            <div className="container-fluid">
              <div className="row">
                {mostSubscribedCourse && mostSubscribedCourse.map((course, index) => {
