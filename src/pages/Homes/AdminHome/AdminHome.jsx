            ...
            <div className="col-lg-9 col-md-12 col-sm-12 col-xs-12">
              <div className="product-sales-chart">
                ...
                <ul className="list-inline cus-product-sl-rp">
                  <li>
                    <h5><i className="fa fa-circle" style={{ color: '#006DF0' }}></i>CSE</h5>
                  </li>
                  <li>
                    <h5><i className="fa fa-circle" style={{ color: '#933EC5' }}></i>Accounting</h5>
                  </li>
                  <li>
                    <h5><i className="fa fa-circle" style={{ color: '#65b12d' }}></i>Electrical</h5>
                  </li>
                </ul>
